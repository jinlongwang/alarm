...
public class Property {  
    ...
    public static String readData(String filePath, String key) {  
        //获取绝对路径  
        filePath = Property.class.getResource("/" + filePath).toString();  
        //截掉路径的”file:“前缀  
    ...
    public static void main(String[] args) {  
        //System.out.println(Property.readData("weibo/config/sinceID.properties", "since_status_id"));  
    	Property.writeData("weibo/config/sinceID.properties", "since_status_id", "09876");  
        System.out.println(Property.readData("weibo/config/sinceID.properties", "since_status_id"));  
